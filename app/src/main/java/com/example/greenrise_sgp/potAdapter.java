...
import java.util.Calendar;
    ...
    public class potAdapter extends FirebaseRecyclerAdapter<Model, potAdapter.myViewHolder> {
        ...
        int m=0,k=0;
        Model model;
        public potAdapter(@NonNull FirebaseRecyclerOptions<Model> options) {
            super(options);
        }
...
//        holder.quantityInCart.setVisibility(View.GONE);
            ...
            DatabaseReference plant =  db.getReference("Pots");
