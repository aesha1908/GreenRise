...
public class flower1Adapter extends FirebaseRecyclerAdapter<Model, flower1Adapter.myViewHolder> {
        ...
        int m=0,k=0;
        Model model;
        public flower1Adapter(@NonNull FirebaseRecyclerOptions<Model> options) {
            super(options);
        }
        @Override
        protected void onBindViewHolder(@NonNull flower1Adapter.myViewHolder holder, int position, @NonNull Model model) {
...
//        holder.quantityInCart.setVisibility(View.GONE);
            ...
            DatabaseReference plant =  db.getReference("Flowers");
