...
public class pebbleAdapter extends FirebaseRecyclerAdapter<Model, pebbleAdapter.myViewHolder> {
        ...
        int m=0,k=0;
        Model model;
        public pebbleAdapter(@NonNull FirebaseRecyclerOptions<Model> options) {
            super(options);
        }

        @Override
        protected void onBindViewHolder(@NonNull pebbleAdapter.myViewHolder holder, int position, @NonNull Model model) {
...
//        holder.quantityInCart.setVisibility(View.GONE);
            ...
            DatabaseReference plant =  db.getReference("Pebbles");
...
//        });
        ...
        @NonNull
        @Override
        public pebbleAdapter.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerowdesign,parent,false);
            return new pebbleAdapter.myViewHolder(view);
        }
