...
public class PebblesAdapter extends BaseAdapter {
    Context context;
    List<Pebble> list;
    int IMAGE_REQUEST_CODE = 7;
    Uri uri;
    FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
    DatabaseReference reference = firebaseDatabase.getReference("Pebbles");

    public PebblesAdapter(Context context, List<Pebble> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        quantity.setText("Quantity: " + list.get(i).getQuantity() + " kg");
